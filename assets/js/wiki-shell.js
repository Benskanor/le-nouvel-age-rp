      ...
      <header class="site-header">
        ...
        <details class="mobile-menu">
          ...
          <nav>
            ...
            <a href="${new URL("wiki/economie/", root)}">Économie V4</a><a href="${new URL("wiki/stations/", root)}">Stations de craft</a><a href="${new URL("wiki/ressources/", root)}">Ressources</a><a href="${new URL("wiki/consommables/", root)}">Consommables</a><a href="${new URL("wiki/nouveautes/", root)}">Nouveautés</a>
